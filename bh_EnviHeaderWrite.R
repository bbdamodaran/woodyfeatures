...
# Bitumen, Self building blocks, Shadow}'
  ...
  # hedge
  def$classes=2
  def$class_lookup<- '{0,0,0, 255,255,255, 0,255,0}'
  def$class_names<-'{Background,Hed&Bush}'
...
# RCD 30
#   def$classes=6
#   def$class_lookup<- '{0,0,0, 255,0,0, 0,255,0, 204,255,153, 192,192,192, 0,102,0, 255,128,0}'
#   def$class_names<-'{Unclassified, Building, Hed&Bush, Grass, Road&Parklot, Tree, Wall&Carport}'
